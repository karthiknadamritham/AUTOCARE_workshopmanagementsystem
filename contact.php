...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($email) || empty($subject) || empty($message)) {
        ...
        $sql = "INSERT INTO contact_inquiries (name, email, subject, message, submission_date) 
                VALUES (?, ?, ?, ?, NOW())";
        ...
        if ($stmt->execute()) {
            ...
            $errorMessage = "Sorry, there was an error submitting your message. Please try again later.";
            echo "<script>showAlert('$errorMessage', 'error');</script>";
        }
...
<head>
    ...
    <title>Contact Us - AutoCare Workshop</title>
    ...
    <section class="pt-32 pb-20 relative bg-gradient-to-br from-primary-600 via-primary-500 to-secondary-600">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-2xl mx-auto text-center text-white">
                ...
                <p class="text-lg text-white/80">Have questions or need assistance? We're here to help you with all your automotive needs.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600">+1 987 654 321</p>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600">info@autocare.com</p>
                    <p class="text-gray-600">support@autocare.com</p>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 text-center hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-600">123 Workshop Street</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="p-8 lg:p-12">
                        ...
                        <div class="bg-green-50 p-4 rounded-lg mb-6">
                            <p class="text-green-800"><?php echo htmlspecialchars($successMessage); ?></p>
                        </div>
                        <?php endif; ?>
                        
                        <?php if ($errorMessage): ?>
                        <div class="bg-red-50 p-4 rounded-lg mb-6">
                            <p class="text-red-800"><?php echo htmlspecialchars($errorMessage); ?></p>
                        </div>
                        <?php endif; ?>
                        ...
                        <form id="contactForm" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                            <div class="mb-6">
                                ...
                                <input type="text" id="name" name="name" value="<?php echo isset($name) ? htmlspecialchars($name) : ''; ?>" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                            </div>
                            <div class="mb-6">
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                                <input type="email" id="email" name="email" value="<?php echo isset($email) ? htmlspecialchars($email) : ''; ?>" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                            </div>
                            <div class="mb-6">
                                <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Subject</label>
                                <input type="text" id="subject" name="subject" value="<?php echo isset($subject) ? htmlspecialchars($subject) : ''; ?>" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">
                            </div>
                            <div class="mb-6">
                                <label for="message" class="block text-sm font-medium text-gray-700 mb-2">Your Message</label>
                                <textarea id="message" name="message" rows="5" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500"><?php echo isset($message) ? htmlspecialchars($message) : ''; ?></textarea>
                            </div>
                            <button type="submit" class="w-full bg-primary-600 text-white py-3 px-6 rounded-lg hover:bg-primary-700 transition-colors">
                                Send Message
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="bg-gray-200">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3456.789012345678!2d-123.12345678901234!3d49.12345678901234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDnCsDA3JzI0LjQiTiAxMjPCsDA3JzI0LjQiVw!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 shadow-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="p-4">
                            <h3 class="text-xl font-semibold text-gray-900 mb-4">Weekends</h3>
                            <ul class="space-y-2">
                                <li class="flex justify-between">
                                ...
                                <li class="flex justify-between">
                                    ...
                                    <span class="font-medium text-primary-600">Closed</span>
                                </li>
                            </ul>
                            <div class="mt-6 pt-6 border-t border-gray-200">
                                <h4 class="font-semibold text-gray-900 mb-2">Emergency Service</h4>
                                <p class="text-gray-600">Available 24/7 - Call our emergency hotline</p>
                                <p class="text-primary-600 font-semibold mt-2">+1 234 567 890</p>
                            </div>
                        </div>
                    </div>
                </div>
